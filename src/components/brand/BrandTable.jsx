...
const BrandTable = props => {
  ...
  const formAction = useCallback(
    (action, data = null) => {
      ...
      if (action === "add") {
        ...
        history.push(`/brand/edit/${data.brandId}`, data);
      }
    },
    [history]
  );
      ...
      Cell: props => (
        <div className="react-action-class">
          ...
          <Button
            ...
            onClick={() => {
              setToggle(!toggle);
              setdeleteId(props.original.brandId);
            }}
          >
            <div className="fs-14 medium-text">
  ...
  const callListApi = params => {
    setLoader(true);
    Api.post("/admin/brand/list", params)
      .then(res => {
  ...
  const handleYes = () => {
    setLoading(true);
    Api.delete(`/admin/brand/delete?brandId=${deleteId}`)
      .then(res => {
        ...
        <div className="roe-card-style mtb-15">
          <div className="roe-card-header module-header">
            <div className="flex-1 fs-16 demi-bold-text">
              <span className="hash"># </span> Brand List
            </div>
            <div className="mr-10">
              <input
                value={searchText}
            ...
            <div>
              ...
              >
                <i className="fas fa-plus mr-10"></i>Add Brand
              </Button>
            </div>
          </div>
          ...
          <CommonModal
            ...
            viewModalCheck={true}
            headerData={"Brand Details"}
            children={<BrandModal data={viewData} />}
          />
