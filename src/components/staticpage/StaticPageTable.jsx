...
const StaticPageTable = props => {
  ...
  const formAction = useCallback(
    (action, data = null) => {
      ...
      if (action === "edit") {
        history.push(`/static-page/edit/${data.pageId}`, data);
      }
    },
    [history]
  );
  ...
  const callListApi = params => {
    setLoader(true);
    Api.post("staticPage/admin/list", params)
      .then(res => {
        ...
        <div className="roe-card-style mtb-15">
          <div className="roe-card-header module-header">
            <div className="flex-1 fs-16 demi-bold-text">
              <span className="hash"># </span> Static Page List
            </div>
            <div className="mr-10">
              <input
                value={searchText}
          ...
          <CommonModal
            ...
            viewModalCheck={true}
            headerData={"Static Page Details"}
