  ...
  return (
    <div>
      <form>
        ...
        <div className="form-group row">
          <label className="col-sm-2 col-form-label">With Help Input</label>
          <div className="col-sm-10">
            <input
              type="email"
              className="form-control react-form-input"
        ...
        <div className="form-group row">
          <label className="col-sm-2 col-form-label">multiple select</label>
          <div className="col-sm-10">
            <select multiple className="form-control react-form-input">
              <option>1</option>
              <option>2</option>
              <option>3</option>
              <option>4</option>
        ...
        <div className="form-group row">
          <label className="col-sm-2 col-form-label">Range Input</label>
          <div className="col-sm-10">
            <input
              type="range"
        ...
        <div className="form-group row theme-color">
          <label className="col-sm-2 col-form-label">File Input</label>
          <div className="col-sm-10">
            <input
              type="file"
        ...
        <div className="form-group row">
          <label className="col-sm-2 col-form-label">Radio Buttons</label>
          <div className="col-sm-10">
        ...
        <div className="form-group row">
          <label className="col-sm-2 col-form-label">Checkboxes</label>
          <div className="col-sm-10">
            <div className="form-check form-check-inline">
              <input
                className="form-check-input"
