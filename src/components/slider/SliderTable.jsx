...
const SliderTable = props => {
  ...
  const formAction = useCallback(
    (action, data = null) => {
      ...
      if (action === "add") {
        ...
        history.push(`/slider/edit/${data.sliderId}`, data);
      }
    },
    [history]
  );
  ...
  const columns = [
    ...
    },
    {
      ...
      height: 300,
      Cell: props => (
        <div className="flex justify-center align-center fill-width">
          <div
            style={{
              display: "flex",
              height: "48px",
      ...
      Cell: props => (
        <div className="react-action-class">
          ...
          <Button
            ...
            onClick={() => {
              setToggle(!toggle);
              setdeleteId(props.original.sliderId);
            }}
          >
            <div className="fs-14 medium-text">
  ...
  const callListApi = params => {
    setLoader(true);
    Api.post("/admin/slider/list", params)
      .then(res => {
  ...
  const handleYes = () => {
    setLoading(true);
    Api.delete(`/admin/slider/delete?sliderId=${deleteId}`)
      .then(res => {
        ...
        <div className="roe-card-style mtb-15">
          <div className="roe-card-header module-header">
            <div className="flex-1 fs-16 demi-bold-text">
              <span className="hash"># </span> Slider Images List
            </div>
            {/* <div className="mr-10">
              <input
                value={searchText}
            ...
            <div>
              ...
              >
                <i className="fas fa-plus mr-10"></i>Add Slider Image
              </Button>
            </div>
          </div>
...
export default compose(connect(mapStateToProps, null), withRouter)(SliderTable);
