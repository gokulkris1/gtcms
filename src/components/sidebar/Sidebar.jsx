...
import { sidebarData, storeSidebarData } from "util/data/sidebar";
import { Applogo, AppName } from "helper/constant";
...
const Sidebar = props => {
  ...
  useEffect(() => {
    // if (storePaths.includes(pathname)) {
    //   setSideBar(storeSidebarData);
    // } else {
        ...
        <div className="sidebar-header">
          <NavLink to={"/"} className="simple-text logo-mini">
            <div className="logo-img">
              <img src={Applogo} alt="react-logo" height={48} />
            </div>
          </NavLink>
