        ...
        <div className="plr-15">
          <div className="mtb-30 theme-color">
            ...
            <div className="mtb-10">
              This is simple quick start app. you can easily setup your theme as
            ...
            <div className="mtb-10">
              We removed all the components, views, and unnecessary things in
              quick start app.If you want any components please refer our Roe
              app.
            </div>
          </div>
        </div>
