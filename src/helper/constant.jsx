export const AppName = "Green Till";
export const Applogo = require("assets/images/logo.svg");
export const drawerWidth = "320px";
...
export const NAMES = {
  android: "Android",
  ios: "IOS",
  CAMERA: "App Camera Upload",
  GALLERY: "App Gallery Upload",
  NATIVE_CAMERA_SCANNED: "Native Camera Scan",
  googleCount: "Google",
  facebookCount: "Facebook",
  normalCount: "App",
  appleCount: "iOS",
  APP_QR_SCANNED: "APP QR Scan",
  UNSCANNED: "Device"
};

export const RECEIPT_TYPE = {
  ALL: "ALL",
  cameraReceiptCount: "CAMERA",
  uploadedReceiptCount: "GALLERY",
  scannedReceiptCount: "NATIVE_CAMERA_SCANNED",
  appScannedReceiptCount: "APP_QR_SCANNED",
  unscannedReceiptCount: "UNSCANNED",
  CAMERA: "App Camera Upload",
  GALLERY: "App Gallery Upload",
  NATIVE_CAMERA_SCANNED: "Native Camera Scan",
  APP_QR_SCANNED: "APP QR Scan",
